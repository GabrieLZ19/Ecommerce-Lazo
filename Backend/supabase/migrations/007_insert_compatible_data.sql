...
DELETE FROM public.categories WHERE name IN ('Electrónicos', 'Ropa', 'Hogar', 'Deportes', 'Libros', 'Belleza');

-- Insertar categorías usando la estructura existente (con slug)
